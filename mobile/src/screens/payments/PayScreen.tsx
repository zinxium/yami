    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <View style={{ paddingHorizontal: 20, paddingBottom: 12, paddingTop: insets.top + 8 }}>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
          <Logo size="small" />
          <Text style={{ color: colors.textPrimary, fontSize: 20, fontWeight: 'bold' }}>Paiements</Text>
        </View>
        <Text style={{ color: colors.textSecondary, fontSize: 13, marginLeft: 48 }}>Enregistre un paiement sur un prêt</Text>
      </View>
      ...
      >
        {activeLoans.length === 0 ? (
          <View style={{ alignItems: 'center', paddingVertical: 64 }}>
            ...
            <Text style={{ color: colors.textSecondary, fontSize: 15, marginTop: 12 }}>Aucun prêt actif.</Text>
          </View>
        ) : (
          <View style={{ gap: 12 }}>
              ...
              >
                <Card style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: colors.surface }}>
                  ...
                  <View style={{ flex: 1, marginLeft: 12 }}>
                    ...
                    <Text style={{ color: colors.textSecondary, fontSize: 12 }}>Reste : {formatCurrency(Number(loan.remaining_balance))}</Text>
                  </View>
